...
const MyMentors = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">My Mentors</h1>
        <p className="text-gray-600">Connect with your mentors, schedule sessions, and continue your learning journey.</p>
