...
import { Loader2, GraduationCap, BookOpen, Globe, Sparkles } from "lucide-react";
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-br from-bridgeblue-600 via-bridgeblue-500 to-bridgeblue-700 overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center items-start px-16 text-white">
          ...
          <p className="text-xl text-white/80 mb-8 leading-relaxed max-w-md">
            Continue your learning journey and connect with mentors who can guide you to success.
          </p>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-4 sm:p-6 lg:p-12 relative min-h-screen lg:min-h-0">
        ...
        <div className="w-full max-w-md relative z-10 py-6 lg:py-0">
          ...
          <div className="bg-white/90 backdrop-blur-2xl rounded-3xl shadow-2xl border border-white/30 p-6 sm:p-8 lg:p-10 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-150 relative overflow-hidden">
            ...
            {/* Sign Up Link */}
            <div className="text-center pt-4 sm:pt-6 border-t border-gray-100 relative z-10">
          ...
          {/* Additional Links - Mobile Only - Enhanced */}
          <div className="lg:hidden mt-6 text-center space-y-3 relative z-10">
            <div className="flex items-center justify-center gap-4 text-sm text-gray-600">
              <Link to="/mentor/register" className="hover:text-bridgeblue-600 transition-colors duration-200 font-medium px-3 py-1.5 rounded-lg hover:bg-bridgeblue-50">
              Are you a mentor?
            </Link>
              <span className="text-gray-400">•</span>
              <Link to="/help" className="hover:text-bridgeblue-600 transition-colors duration-200 font-medium px-3 py-1.5 rounded-lg hover:bg-bridgeblue-50">
              Need Help?
            </Link>
            </div>
