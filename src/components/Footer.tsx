    ...
    <footer className="bg-gray-50 pt-16 pb-10 md:pt-20 md:pb-12">
      <div className="container mx-auto px-4 md:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 mb-12">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-bold text-gray-900 mb-5 text-base md:text-lg">Quick Links</h3>
            <ul className="space-y-3">
              <li>
                <Link 
                  to="/" 
                  className="text-gray-600 hover:text-bridgeblue-500 text-sm md:text-base transition-colors duration-200 inline-block focus:outline-none focus:ring-2 focus:ring-bridgeblue-500 focus:ring-offset-2 rounded px-1"
                >
                  Home
                </Link>
              </li>
          ...
          {/* For Students */}
          <div>
            <h3 className="font-bold text-gray-900 mb-5 text-base md:text-lg">For Students</h3>
            <ul className="space-y-3">
              <li>
                <Link 
                  to="#" 
          ...
          {/* For Mentors */}
          <div>
            <h3 className="font-bold text-gray-900 mb-5 text-base md:text-lg">For Mentors</h3>
            <ul className="space-y-3">
              <li>
                <Link 
                  to="#" 
        ...
        <div className="border-t border-gray-200 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex space-x-5 order-1 md:order-2">
            <a 
              href="#" 
              className="text-gray-500 hover:text-bridgeblue-500 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-bridgeblue-500 focus:ring-offset-2 rounded p-1"
              aria-label="Facebook"
            >
